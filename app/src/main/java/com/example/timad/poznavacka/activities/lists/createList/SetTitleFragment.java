 ...
 * {@link SetTitleFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SetTitleFragment#newInstance} factory method to
...
public class SetTitleFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onEditTitleChange(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onEditTitleChange(Uri uri);
    }
}
